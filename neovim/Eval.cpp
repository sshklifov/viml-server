...
static const char *e_dictrange = "E719: Cannot use [:] with a Dictionary";
static const char *e_nowhitespace = "E274: No white space allowed before parenthesis";
static const char *e_write2 = "E80: Error while writing: %s";
static const char *e_string_list_or_blob_required = "E1098: String, List or Blob required";
static const char e_expression_too_recursive_str[] = "E1169: Expression too recursive: %s";
static const char e_dot_can_only_be_used_on_dictionary_str[] = "E1203: Dot can only be used on a dictionary: %s";
static const char * namespace_char = "abglstvw";
